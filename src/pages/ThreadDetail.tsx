...
// import { getThreadById } from "@/services/Services";
// import { Card, CardContent } from "@/components/ui/card";
// import { Avatar, AvatarImage, AvatarFallback } from "@/components/ui/avatar";
// import type { ThreadDetailType } from "@/types/Type";
// import { Button } from "./button";
// import ReplayDetail from "./Replay";
// import { io } from "socket.io-client";
// import { ArrowLeft, Heart, MessageSquareText } from "lucide-react";
...
//   const { addReply, handleLike, handleUnlike } = useThread();
...
//       thread_id,
//     };
//     const res = await addReply(params, rp);
//     console.log(res);
...
//       } catch (err) {
//         console.error("Gagal load thread detail", err);
//       }
//     };
...
//               <AvatarImage src={thread.user.profile_picture || undefined} />
...
//             <button onClick={() => (thread.userLiked ? handleUnlike(thread.id) : handleLike(thread.id))}>
//               <Heart className={thread.userLiked ? "text-red-500" : "text-gray-400"} />
//             </button>
//             {thread.likes}
//             <MessageSquareText /> {thread.replies}
//           </div>
//         </CardContent>
//       </Card>
    ...
    <div className="p-6">
      ...
      <Card className="bg-neutral-900 border-neutral-800 text-white mb-4">
        <CardContent>
          ...
          <div className="flex items-center gap-6 text-neutral-400 text-sm ">
            <button onClick={() => toggleLike(thread.id, thread.userLiked)}>
              <Heart className={thread.userLiked ? "text-red-500" : "text-gray-400"} />
            </button>
            {thread.likes}
            <MessageSquareText /> {thread.reply}
          </div>
        </CardContent>
      </Card>
      <div className="px-4 mb-6">
